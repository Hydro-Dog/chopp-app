...
import { pushWsMessage, setWsConnected, setWsError, wsConnect, wsDisconnect, wsSend } from "@store/index";

import { io, Socket } from "socket.io-client";
import { pushWsNotification } from "../slices/notifications-slice";
    ...
    if (action) {
      switch (action?.type) {
        case wsConnect.toString():
          ...
          if (!AsyncStorage.getItem(STORAGE_KEYS.ACCESS_TOKEN)) {
